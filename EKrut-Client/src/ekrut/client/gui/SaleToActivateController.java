...
/**
 * This class is responsible for activating and deactivating a sale. It extends
 * the HBox class and displays the sale information. It allows the
 * MARKETING_WORKER to activate or deactivate a sale.
 * 
 * @author Nir Betesh
 */
public class SaleToActivateController extends HBox {
	...
	/**
	 * Constructor for SaleToActivateController class
	 *
	 * This constructor initializes the SaleToActivateController object by setting
	 * the saleDiscount, clientSalesManager, daysOfSale, fxmlLoader,
	 * activateSaleBtn, deactivateSaleBtn, dayOfSaleTxt, endTimeTxt, saleTypeTxt and
	 * startTimeTxt fields.
	 *
	 * @param saleDiscount The SaleDiscount object that the controller will operate
	 *                     on
	 * @param activeSales  The ArrayList of SaleDiscount objects that are currently
	 *                     active
	 *
	 */
