...
/**
 * OrderReportViewController is the controller class for the order report view
 * screen.
 * 
 * It allows to view the order reports, such as the location, area, date, number
 * of orders, top sellers and the charts for it.
 * 
 * It receives the report object from the previous controller,
 * ReportChooserController and sets the values in the GUI elements.
 * 
 * The report object contains all the data for the report and it is fetched from
 * the server using ClientReportManager.
 * 
 * @author Tal Gaon
 */
public class OrderReportViewController {
	...
	/**
	 * This method sets the report object as a class variable and updates various
	 * labels and charts based on the information in the report object.
	 * 
	 * @param report The report object to be set as a class variable and used to
	 *               update the labels and charts.
	 */
